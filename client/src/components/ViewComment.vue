      ...
      <v-card>
        <v-form>
          <v-text-field
            ...
            :error-messages="
              v$.editedComment.title.$errors.map((e) => e.$message)
            "
          ...
          <v-textarea
            ...
            :error-messages="
              v$.editedComment.body.$errors.map((e) => e.$message)
            "
            @blur="v$.editedComment.body.$touch"
          />
          <v-btn color="amber" size="small" @click="edit">Update Comment</v-btn>
          <v-btn color="grey" size="small" @click="isEditing = false"
            >Cancel</v-btn
          >
        </v-form>
      </v-card>
      ...
      <v-card>
              ...
              <v-card-subtitle>
                <h4>
                  ...
                  <router-link
                    :to="{
                      name: 'user-id',
                      params: { userId: comment.owner._id },
                    }"
                  >
        ...
        <v-card-actions v-if="isOwner">
          <v-btn
            ...
            >Edit</v-btn
          >
          <v-btn color="red-darken-4" variant="tonal" size="small" @click="del"
            >Delete</v-btn
          >
        </v-card-actions>
      </v-card>
